...
<CardGroup cols={3}>
  ...
  <Card title="Pluggable Architecture" icon="plug" href="/open-source/features/pluggable-architecture-factory-abstraction">
    Understand how Factory + abstraction layers make providers swappable.
  </Card>
</CardGroup>
