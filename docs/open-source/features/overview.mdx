...
<CardGroup cols={3}>
  ...
  <Card title="Retrieval Pipeline Internals" icon="diagram-project" href="/open-source/features/retrieval-pipeline-internals">
    Code-level walkthrough of query → embed → vector search → threshold → rerank.
  </Card>
